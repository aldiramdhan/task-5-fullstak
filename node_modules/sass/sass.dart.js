...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    CancelableOperation_CancelableOperation$fromFuture(result, onCancel, $T) {
      var t1 = A.CancelableCompleter$(onCancel, $T);
      t1.complete$1(result);
      return t1.get$operation();
    },
    CancelableOperation_race(operations, $T) {
      var t1, _cancelAll, completer, t2, _i, _box_0 = {};
      _box_0.operations = operations;
      t1 = A._setArrayType(operations.slice(0), A._arrayInstanceType(operations));
      operations = _box_0.operations = t1;
      t1 = operations.length;
      if (t1 === 0)
        throw A.wrapException(A.ArgumentError$("May not be empty", "operations"));
      _box_0.done = false;
      _cancelAll = new A.CancelableOperation_race__cancelAll(_box_0, $T);
      completer = A.CancelableCompleter$(_cancelAll, $T);
      for (t2 = type$.Null, _i = 0; _i < operations.length; operations.length === t1 || (0, A.throwConcurrentModificationError)(operations), ++_i)
        J.then$1$2$onError$x(operations[_i], new A.CancelableOperation_race_closure(_box_0, _cancelAll, completer, $T), new A.CancelableOperation_race_closure0(_box_0, _cancelAll, completer), t2);
    ...
    CancelableOperation_race__cancelAll: function CancelableOperation_race__cancelAll(t0, t1) {
      this._box_0 = t0;
      this.T = t1;
    },
    CancelableOperation_race__cancelAll_closure: function CancelableOperation_race__cancelAll_closure(t0) {
      this.T = t0;
    },
    CancelableOperation_race_closure: function CancelableOperation_race_closure(t0, t1, t2, t3) {
      var _ = this;
      _._box_0 = t0;
      _._cancelAll = t1;
      _.completer = t2;
    ...
    CancelableOperation_race__closure0: function CancelableOperation_race__closure0(t0, t1) {
      this.completer = t0;
      this.value = t1;
    },
    CancelableOperation_race_closure0: function CancelableOperation_race_closure0(t0, t1, t2) {
      this._box_0 = t0;
      this._cancelAll = t1;
      this.completer = t2;
    },
    CancelableOperation_race__closure: function CancelableOperation_race__closure(t0, t1, t2) {
      this.completer = t0;
      this.error = t1;
      this.stackTrace = t2;
    },
    ...
    CancelableCompleter: function CancelableCompleter(t0, t1, t2, t3) {
      var _ = this;
      _._cancelable_operation$_inner = t0;
      _._cancelCompleter = t1;
      _._onCancel = t2;
      _._mayComplete = true;
      _.__CancelableCompleter_operation = $;
      _.$ti = t3;
    },
    ...
    watch(options, graph) {
      return A.unwrapCancelableOperation(new A.watch_closure(options, graph).call$0(), type$.void);
    },
    watch_closure: function watch_closure(t0, t1) {
      this.options = t0;
      this.graph = t1;
    },
    watch__closure: function watch__closure(t0) {
      this.dirWatcher = t0;
    },
    ...
    _Watcher_watch_closure: function _Watcher_watch_closure(t0, t1, t2) {
      this._box_0 = t0;
      this.$this = t1;
      this.watcher = t2;
    },
    _Watcher_watch_closure0: function _Watcher_watch_closure0(t0) {
      this._box_0 = t0;
    },
    ...
    onStdinClose() {
      var completer = A.CancelableCompleter$(null, type$.void);
      if (J.$eq$(self.process.stdin.isTTY, true))
        J.on$2$x(J.get$stdin$x(self.process), "end", A.allowInterop(new A.onStdinClose_closure(completer)));
      return completer.get$operation();
    },
    watchDir(path, poll) {
      var t2, t3, t1 = {},
    ...
    onStdinClose_closure: function onStdinClose_closure(t0) {
      this.completer = t0;
    },
    ...
    unwrapCancelableOperation(future, $T) {
      var completer = A.CancelableCompleter$(new A.unwrapCancelableOperation_closure(future, $T), $T);
      future.then$1$2$onError(0, new A.unwrapCancelableOperation_closure0(completer, $T), completer.get$completeError(), type$.Null);
      return completer.get$operation();
    },
    ...
    unwrapCancelableOperation_closure: function unwrapCancelableOperation_closure(t0, t1) {
      this.future = t0;
      this.T = t1;
    },
    unwrapCancelableOperation__closure: function unwrapCancelableOperation__closure(t0) {
      this.T = t0;
    },
    unwrapCancelableOperation_closure0: function unwrapCancelableOperation_closure0(t0, t1) {
      this.completer = t0;
      this.T = t1;
    },
    ...
    StatementSearchVisitor_visitIfRule_closure: function StatementSearchVisitor_visitIfRul